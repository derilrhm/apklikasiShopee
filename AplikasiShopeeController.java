...
public class AplikasiShopeeController {
    ...
    private void initializeData() {
        ...
        Produk produk1 = new Produk("P001", "Produk 1", 50000, 10);
        Produk produk2 = new Produk("P002", "Produk 2", 75000, 5);
        
        produkList.put(produk1.getIdProduk(), produk1);
        produkList.put(produk2.getIdProduk(), produk2);
    }
